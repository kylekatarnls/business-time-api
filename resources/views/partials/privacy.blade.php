<div class="page-header">
    <h1 class="text-xl font-bold">Privacy &amp; Cookie Policy</h1>
    <hr>
</div>
<p class="my-6">
    This Privacy Policy governs the manner in which {{ $appName }} collects, uses, maintains and discloses
    information collected from users (each, a "User") of the {{ $url }} website ("Site").
    This privacy policy applies to the Site and all products and services offered by {{ $appName }}<span class="optional-mention">
        (including its API)</span>.
</p>
<h2 class="text-lg font-bold">Personal identification information</h2>
<p class="my-6">
    We may collect personal identification information from Users in a variety of ways, including, but not
    limited to, when Users visit our site, register on the site, place an order, take a subscription,
    fill out a form, and in connection with other activities, services, features or resources
    we make available on our Site.
    <span class="optional-mention">For instance, we record the IP address to count sessions</span>
    Users may be asked for, as appropriate,name, email address, mailing
    address. Users may, however, visit our Site anonymously. We will collect personal identification
    information from Users only if they voluntarily submit such information to us. Users can always refuse
    to supply personally identification information, except that it may prevent them from engaging in
    certain Site related activities.
</p>
<h2 class="text-lg font-bold">Non-personal identification information</h2>
<p class="my-6">
...
<h2 class="text-lg font-bold">Web browser cookies</h2>
<p class="my-6">
    Our Site may use "cookies" to enhance User experience. User's web browser places cookies on their hard
    drive for record-keeping purposes and sometimes to track information about them. User may choose to
...
<p class="my-6">
    ...
    practices employed by websites linked to or from our Site. In addition, these sites or services,
    including their content and links, may be constantly changing. These sites and services may have
    their own privacy policies and customer service policies. Browsing and interaction on any other
...
<h2 class="text-lg font-bold">Your acceptance of these terms</h2>
<p class="my-6">
...
<h2 class="text-lg font-bold">Contacting us</h2>
<p class="my-6">
