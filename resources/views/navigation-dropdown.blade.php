            ...
            <div class="hidden sm:flex sm:items-center sm:ml-6">
                <x-jet-dropdown align="right" width="48">
                    ...
                    <x-slot name="content">
                        ...
                        <x-jet-dropdown-link href="{{ route('privacy') }}">
                            {{ __('Privacy') }}
                        </x-jet-dropdown-link>

                        <x-jet-dropdown-link href="{{ route('terms') }}">
                            {{ __('Terms of Service') }}
                        </x-jet-dropdown-link>
    ...
    <div :class="{'block': open, 'hidden': ! open}" class="hidden sm:hidden">
        ...
        <div class="pt-4 pb-1 border-t border-gray-200">
            ...
            <div class="mt-3 space-y-1">
                ...
                <x-jet-responsive-nav-link href="{{ route('privacy') }}">
                    {{ __('Privacy') }}
                </x-jet-responsive-nav-link>
                ...
                @if(Auth::user()->isSuperAdmin())
                    <x-jet-responsive-nav-link href="{{ route('admin-users') }}">
                        {{ __('Users') }}
                    </x-jet-responsive-nav-link>
