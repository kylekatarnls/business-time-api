...
return [
    ...
    */
    ...
    'features' => [
        ...
        'contact' => (bool) env('FEATURE_CONTACT', false),
    ],

    'free_unlimited' => (bool) env('FREE_UNLIMITED', true),
    ...
    'special_limit' => (static function ($envVar) {
        $limits = [];

        if ($envVar) {
            foreach (explode(',', $envVar) as $domain) {
                [$domain, $limit] = explode(':', $domain);

                $limits[$domain] = (int) $limit;
            }
        }
